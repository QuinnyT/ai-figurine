...
// MY TESTING DEMO PAGE
import Dashboard from "./pages/Dashboard"
import TestAppearance from "./pages/TestAppearance"
import TestAnimation from "./pages/TestAnimation"


// dynamically import the manifest
// const assetImportPath = import.meta.env.VITE_ASSET_PATH + "/manifest.json"
const assetImportPath = import.meta.env.VITE_ASSET_PATH + "/testmanifest.json"
...
export default function App() {
  ...
  const updateCameraPosition = () => {
    ...
    if (controls) {
      if (
        [ViewMode.APPEARANCE, ViewMode.SAVE, ViewMode.OPTIMIZER, ViewMode.BATCHDOWNLOAD, ViewMode.BATCHMANIFEST, ViewMode.ANIMATION].includes(viewMode)
      ) {
  ...
  const pages = {
    ...
    [ViewMode.ANIMATION]: <TestAnimation />,
