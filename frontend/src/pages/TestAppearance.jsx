...
import styles from "./TestAppearance.module.css"
...
import TestBottomDisplayMenu from "../components/TestBottomDisplayMenu.jsx"
...
import TestRightPanel from "../components/TestRightPanel.jsx"
...
function Test() {
  ...
  */
  ...
  React.useEffect(() => {
    console.log("selectedTraitGroup", selectedTraitGroup)
  }, [selectedTraitGroup])

  React.useEffect(() => {
    console.log("selectedBlendshapeTraits", selectedBlendshapeTraits)
  }, [selectedBlendshapeTraits])
  ...
  const handleLeftTriggerClick = () => {
    if (leftPanelShowing) {
      moveCamera({ targetY: 0.8, distance: 7 })
    }
    setLeftPanelShowing(!leftPanelShowing)
    setTraits(null);
    setSelectedTraitGroup(null)
    setSelectedTrait(null);
    setSelectedBlendshapeTraits({})
  ...
  return (
    <div className={styles.container}>
            ...
            <div className={styles["editor-container"]}>
              <div className={styles["editor-tab"]}>
              {
                characterManager.getGroupTraits().map((traitGroup, index) => (
                  ...
                  style={{ backgroundImage: traitGroup.trait == selectedTraitGroup?.trait ? "url('ui/seleced_button_bg.png')" : ''}}
                  onClick={() => {
      ...
      <img className={styles["leftPanelTriggerIcon"]} src="ui/setting.svg" onClick={handleLeftTriggerClick} />
      ...
      <TestRightPanel  selectedTrait={selectedTrait} selectedVRM={selectedVRM} traitGroupName={selectedTraitGroup?.trait||""} setIsLoading={setIsLoading}/>

      <TestBottomDisplayMenu loadedAnimationName={loadedAnimationName} randomize={randomize}/>
