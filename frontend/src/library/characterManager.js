...
export class CharacterManager {
  ...
  screenshotManager
    ...
    downloadGLB(name, exportOptions = null){
      ...
      console.log("this.manifestData.getExportOptions()", this.manifestData.getExportOptions())
      console.log("exportOptions", exportOptions)

      if (this.canDownload()){
        exportOptions = exportOptions || {}
        const finalOptions = {...this.manifestData.getExportOptions(), ...exportOptions};
        downloadGLB(this.characterModel, name, finalOptions, this.avatar);
      }
      else{
    ...
    loadTraitOptions(options) {
        return new Promise((resolve) => {
            ...
            const promises = options.map(async (option, index) => {
                ...
                // console.log("resultData", resultData[index])
            });
